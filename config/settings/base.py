...
#     "default": env.db(
#         "DATABASE_URL",
#         # default="postgres://localhost/insektizid",
#     ),
# }
...
PASSWORD_HASHERS = [ 
    ...
    "django.contirb.auth.hashers.PBKDF2PasswordHasher",
    "django.contrib.auth.hashers.PBKDF2SHA1PasswordHasher",
    "django.contrib.auth.hashers.BCyrptSHA256PasswordHasher",
] 
...
TEMPLATES = [ 
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [ 
                ...
                "insektizid.users.context_processors.allauth_settings",
            ],
        },
    }
]
...
# ------------------------------------------------------------------------------
# https://docs.django-rest-framework.org/api-guide/settings/
REST_FRAMEWORK = {
